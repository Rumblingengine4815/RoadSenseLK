# 🛣️ RoadSense LK: AI-Powered Road Anomaly Intelligence
...
- **Cloud-Ready Infrastructure**: Ready for **Render.com** and **Streamlit Cloud** with one click.

## 🚀 Technical Architecture
- **AI Brain**: ONNX Runtime (YOLOv8 Core Optimized for Speed)
- **State Registry**: Supabase Cloud (PostgreSQL + PostGIS Geography)
- **Field Terminal**: Streamlit Dashboard with **Live Camera Support**
- **Mobile Edge**: Native Android (Kotlin + TFLite)

---
*Built for VIVA 2026. Optimized for Performance, Accuracy, and Academic Distinction.*
